...
const RankingScreenItem = ({ userPoints }: RankingScreenItemProps) => {
  ...
  React.useEffect(() => {
    if (userPoints!!.userId == user!!.id) setUser(true);
    else setUser(false);
  }, []);

  React.useEffect(() => {
    if (isUser) setImage("../assets/images/avatar-white.png");
    else {
      if (theme == "dark") setImage("../assets/images/avatar-light.png");
      else setImage("../assets/images/avatar-dark.png");
    }
  }, [user]);

  const imageSelector = () => {
    if (isUser) return "../assets/images/avatar-white.png";
    else {
      if (theme == "dark") return "../assets/images/avatar-light.png";
      else return "../assets/images/avatar-dark.png";
    }
  };
    ...
    <View
      style={[
        styles.row,
        {
          ...
          borderColor:
            theme == "dark" ? Colors[theme].white : Colors[theme].text,
        },
      ]}
    >
      {isUser && (
      ...
      <Text
        style={[
          styles.name,
          { color: isUser ? Colors[theme].white : Colors[theme].text },
        ]}
      >

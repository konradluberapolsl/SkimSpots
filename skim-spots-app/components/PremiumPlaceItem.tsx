  ...
  return (
    <View style={styles.card}>
      ...
      >
        <Image
          ...
          source={{
            uri: `http://${yourLocalIP}:8000${
              premiumPlace!!.place!!.pathToImages
            }1.jpg`,
          }}
          blurRadius={blur}
        />
        ...
        <DefaultView
          style={[styles.cardOverlay, { borderColor: Colors[theme].text }]}
        >
          {blur != 0 && (
            <Image
          ...
          {blur != 0 && (
            <Text style={[styles.text, { fontSize: 35 }]}>
              {premiumPlace?.place?.points}+{premiumPlace?.premiumPoints} pkt
            </Text>
          )}
          {blur != 0 && (
            <Text style={[styles.text, { fontSize: 28 }]}>
              {premiumPlace?.place?.estimatedLocalization}
            </Text>
          )}
        </DefaultView>
      </Pressable>
